        ...
        private void Btn_emailsent_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        From = new MailAddress("ks23industries@gmail.com")
                    };
                    ...
                    {
                        UserName = "ks23industries@gmail.com",
                        Password = "cjqsdhjupihgnnsk"
                    };
            ...
            {
                MessageBox.Show(ex + "Error", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
